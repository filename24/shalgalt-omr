# Build & run (https://filename24.github.io/shalgalt-omr/mn/docs/dev/build)
...
Per [ADR 0001](/dev/adr) the project uses the upstream OpenCV prebuilt self-extractor. LLVM
(for opencv-rust's bindgen) ships with recent Visual Studio installs; otherwise install it
from llvm.org.
...
> job-level env in `.github/workflows/ci.yml`, and [ADR 0001](/dev/adr).
